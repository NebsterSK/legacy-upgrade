            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div id="nav-menu" class="nav-menu-collapsible w-full text-right md:text-left md:flex md:w-auto md:items-center md:space-x-6">
                        <a href="#home" class="nav-link nav-scroll block px-3 py-2 md:px-0 md:py-0 nav-link-active">Home</a>

                        <a href="#services" class="nav-link nav-scroll block px-3 py-2 md:px-0 md:py-0">Services</a>

                        <a href="#technology" class="nav-link nav-scroll block px-3 py-2 md:px-0 md:py-0">Technology</a>

                        <a href="#contact" class="nav-link nav-scroll block px-3 py-2 md:px-0 md:py-0">Contact</a>
