...
<div class="py-16">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="font-kanit text-primary-600 dark:text-primary-400 text-4xl mb-6 text-center">Contact</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            {{-- Personal info --}}
            <div class="bg-gray-200 dark:bg-gray-800 rounded-lg shadow-sm p-6 flex flex-col items-center text-center hover:shadow-md transition">
            ...
            {{-- Company details --}}
            <div class="bg-gray-200 dark:bg-gray-800 rounded-lg shadow-sm p-6 flex flex-col items-center text-center md:col-span-2 hover:shadow-md transition">
                <div class="bg-primary-100 dark:bg-primary-950 rounded-full w-14 h-14 flex items-center justify-center mb-4">
