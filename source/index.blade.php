...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16">
    <div class="md:w-3/5 text-center md:text-left">
        ...
        <p class="font-bold text-lg sm:text-xl text-gray-400">Freelance Software Developer</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div class="text-center md:text-left">
                <h2 class="font-kanit text-primary-600 text-2xl mb-4">What I do</h2>
                <p class="text-gray-500">I build <strong>custom software and automation solutions</strong> tailored to each client's business needs. From internal tools and dashboards to API integrations and AI-powered workflows.</p>
                <a href="/services" class="inline-block mt-4 text-primary-600 hover:text-primary-700 font-semibold transition">Services <i class="ri-arrow-right-line"></i></a>
            </div>

            <div class="text-center md:text-left">
                <h2 class="font-kanit text-primary-600 text-2xl mb-4">Why I do it</h2>
                <p class="text-gray-500">Because I love to <strong>solve technological challenges</strong> in the most efficient way. Helping companies modernize, automate, and scale their operations through software.</p>
                <a href="/technology" class="inline-block mt-4 text-primary-600 hover:text-primary-700 font-semibold transition">Tech stack <i class="ri-arrow-right-line"></i></a>
            </div>
        </div>
    </div>
</div>
